...
| `/document-analysis`              | Document analysis (PDF, gist, article, arxiv) — dual-lens. Two user-invokable depths (Standard / Deep); Quick Scan is triage-only. Phase 3/3.5 (v2.0)                           |
...
| `/skill-audit`                    | Interactive behavioral quality audit (12 categories). Phase 5.0 invokes `scripts/skills/<name>/self-audit.js` per [SELF_AUDIT_PATTERN.md](skills/_shared/SELF_AUDIT_PATTERN.md) |
...
| `/repo-analysis`                  | Dual-lens repo analysis: Creator View + Engineer View. Two user-invokable depths (Standard / Deep); Quick Scan is triage-only. Link mining, dual scoring, phase 3.5 (v5.0)      |
...
| Version | Date         | Change                                                                                                                                                                                                                                                                                      |
| ------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 8.10    | 2026-04-15   | Skill-audit batch Wave 6: 4 per-skill self-audit.js scripts (scripts/skills/{repo,website,document,media}-analysis/self-audit.js) wrapping shared CAS floor per SELF_AUDIT_PATTERN.md — adds skill-specific checks (repomix / meta.json / deep-read.md / transcript.md + transcript_source) |
| 8.9     | 2026-04-15   | Skill-audit batch Wave 5 (T28 cleanup): removed "Part of T28 CAS" from recall + synthesize descriptions, dropped "(T29)" from /synthesize header; analyze REFERENCE §4.3 Handler Availability updated to current v2.0/v5.0 versions; version-history traceability preserved                 |
| 8.8     | 2026-04-15   | Skill-audit batch Wave 4 (/analyze): v1.1 → v1.2 — formalize handoff contract ({target, auto_detected_type, flags}) matching handler v2.0 declarations; T28 tagline removed from description; CONVENTIONS ref added                                                                         |
...
| 8.3     | 2026-04-15   | Skill-audit batch Wave 1: `_shared/TAG_SUGGESTION.md` template, CONVENTIONS §18 Prior Feedback Replay, `repo-analysis/ARCHIVE.md` (no command surface change)                                                                                                                               |
