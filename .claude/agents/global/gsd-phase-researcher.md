...
<downstream_consumer> Your RESEARCH.md is consumed by `gsd-planner` which uses
specific sections:
...
**Be prescriptive, not exploratory.** "Use X" not "Consider X or Y." Your
research becomes instructions. </downstream_consumer>
...
**If CONTEXT.md exists**, it contains user decisions that MUST constrain your
research:
