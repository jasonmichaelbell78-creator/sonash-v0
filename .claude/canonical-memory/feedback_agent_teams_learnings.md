...
description: Agent teams and Explore agent operational learnings — role separation, read-only constraints
type: feedback
status: unverified
---
...
- **Why:** Agent misuse wastes tokens and context. Explore agents silently fail writes.
