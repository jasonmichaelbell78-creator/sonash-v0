...
description:
  Agent environment analysis — Phases 1-3 done, Phase 4 improvements next, all 5
  phases before SWS
type: project
status: active
---

5-phase plan at `.planning/agent-environment-analysis/PLAN.md` (22 decisions).
...
- **Apply:** When user says "continue agent work" or "Phase 4", read PLAN.md
  Phase 4 section.
