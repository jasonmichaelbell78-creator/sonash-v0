---
name: project_active_initiatives
description:
  Active project initiatives with status and blockers — SWS, hooks, agent env,
  memory audit
type: project
status: active
---

- **System-Wide Standardization (SWS):** ACTIVE — Phase 0 COMPLETE, Phase 1
...
- **Operational Visibility Sprint:** ~75% — 5 remaining items moved to SWS Phase
  3
- **Product features (M1.5, M1.6, Dev Dashboard):** All PAUSED pending infra
  work
