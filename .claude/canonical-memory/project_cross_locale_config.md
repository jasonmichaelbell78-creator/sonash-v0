...
description: Cross-locale memory sync — shared git artifacts vs locale-specific memory directories
type: project
status: active
---
...
- **Why:** Memory is keyed to project path, so different locales get separate directories.
