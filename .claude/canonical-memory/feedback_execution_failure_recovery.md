...
description: Failure recovery discipline — stop-diagnose-confirm before retrying, no destructive shortcuts
type: feedback
status: active
---
...
- **Why:** Blind retries cascade — each shortcut compounds the next (Session #219 evidence).
- **Apply:** On first failure, pause. Diagnose root cause. Confirm diagnosis. Then fix. If blocked, ask user.
