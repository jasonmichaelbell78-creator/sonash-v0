# System Test — 23-Domain Test Plan
...
This file contains the complete domain definitions for the system-test skill.
Each domain includes its risk level, checks table, key files, known issues, and
suggestion templates.

> **Referenced by:** `.claude/skills/system-test/SKILL.md`
...
| 20.5 | Risk matrix generation         | Rank domains by finding count x severity                    | Per-domain risk table                                      |
...
efficient than 8 separate fixes. Est: E3 as unit vs E2x8.
