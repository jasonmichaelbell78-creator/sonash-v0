...
export const MeetingsService = {
  ...
  async getMeetingsByDay(day: string): Promise<Meeting[]> {
    try {
      ...
      throw new Error(
        `Failed to load meetings for ${day}. Please check your connection and try again.`
      );
    }
  },
  ...
  async seedInitialMeetings() {
    ...
    const seedData: Meeting[] = [
      // MONDAYS (dayIndex=1)
      {
        ...
        coordinates: { lat: 36.1745, lng: -86.7679 },
      },
      {
        id: "mon_2",
        name: "Downtown Lunch Bunch",
        type: "NA",
        day: "Monday",
        dayIndex: 1,
        time: "12:00",
      ...
      },
      {
        ...
        coordinates: { lat: 36.1496, lng: -86.814 },
      },
      {
        id: "mon_4",
        name: "Madison Recovery",
        type: "NA",
        day: "Monday",
        dayIndex: 1,
        time: "19:30",
        address: "500 Gallatin Pike",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Madison",
        coordinates: { lat: 36.251, lng: -86.713 },
      },
      {
        id: "mon_5",
        name: "Green Hills Women",
        type: "AA",
        day: "Monday",
        dayIndex: 1,
        time: "18:00",
        address: "2000 Hillsboro Rd",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Green Hills",
        coordinates: { lat: 36.105, lng: -86.815 },
      },
      ...
      // TUESDAYS (dayIndex=2)
      {
        ...
        dayIndex: 2,
        time: "18:30",
        address: "500 Woodland St",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "East Nashville",
        coordinates: { lat: 36.175, lng: -86.766 },
      },
      {
        id: "tue_2",
        name: "Recovery First",
        ...
        dayIndex: 2,
        time: "20:00",
        address: "100 Demonbreun",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Gulch",
        coordinates: { lat: 36.1522, lng: -86.787 },
      },
      {
        id: "tue_3",
        name: "Sylvan Park Study",
        type: "AA",
        day: "Tuesday",
        dayIndex: 2,
        time: "19:00",
        address: "4200 Murphy Rd",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Sylvan Park",
        coordinates: { lat: 36.138, lng: -86.845 },
      },
      {
        id: "tue_4",
        name: "Antioch New Life",
        type: "NA",
        day: "Tuesday",
        dayIndex: 2,
        time: "19:00",
        address: "5000 Bell Rd",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Antioch",
        coordinates: { lat: 36.05, lng: -86.66 },
      },
      ...
      },
      {
        ...
        zip: "",
        neighborhood: "Downtown",
        coordinates: { lat: 36.1619, lng: -86.7781 },
      },
      {
        id: "wed_3",
        name: "Freedom Group",
        ...
        coordinates: { lat: 36.1813, lng: -86.7949 },
      },
      {
        id: "wed_4",
        ...
        coordinates: { lat: 36.1289, lng: -86.7874 },
      },
      {
        id: "wed_5",
        name: "Belmont Book Study",
        type: "AA",
        day: "Wednesday",
        dayIndex: 3,
        time: "18:00",
        ...
        coordinates: { lat: 36.1325, lng: -86.795 },
      },
      ...
      // THURSDAYS (dayIndex=4)
      {
        ...
        zip: "",
        neighborhood: "Belmont",
        coordinates: { lat: 36.132, lng: -86.798 },
      },
      {
        id: "thu_2",
        name: "Nations Newcomers",
        type: "NA",
        day: "Thursday",
        dayIndex: 4,
        time: "18:30",
        address: "5000 Centennial Blvd",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "The Nations",
        coordinates: { lat: 36.16, lng: -86.845 },
      },
      {
        id: "thu_3",
        name: "Downtown Speaker",
        type: "AA",
        day: "Thursday",
        dayIndex: 4,
        time: "20:00",
        ...
        zip: "",
        neighborhood: "Downtown",
        coordinates: { lat: 36.16, lng: -86.775 },
      },
      ...
      // FRIDAYS (dayIndex=5)
      {
        ...
        dayIndex: 5,
        time: "18:00",
        address: "Coffee Shop Backroom",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Sylvan Park",
        coordinates: { lat: 36.1375, lng: -86.8568 },
      },
      {
        id: "fri_2",
        name: "Late Night NA",
        ...
        dayIndex: 5,
        time: "23:00",
        address: "Recovery Hall",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "Antioch",
        coordinates: { lat: 36.0605, lng: -86.6717 },
      },
      {
        id: "fri_3",
        ...
        dayIndex: 5,
        time: "19:00",
        address: "900 Gallatin Ave",
        city: "Nashville",
        state: "TN",
        zip: "",
        neighborhood: "East Nashville",
        coordinates: { lat: 36.185, lng: -86.755 },
      },
      ...
      // WEEKENDS (dayIndex: Saturday=6, Sunday=0)
      {
        ...
        zip: "",
        neighborhood: "West End",
        coordinates: { lat: 36.148, lng: -86.815 },
      },
      {
        id: "sat_2",
      ...
      },
      {
        ...
        zip: "",
        neighborhood: "Germantown",
        coordinates: { lat: 36.178, lng: -86.79 },
      },
      {
        id: "sun_2",
