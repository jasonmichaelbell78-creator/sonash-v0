...
function findPatternViolations(pattern, content, lines, relativePath) {
  ...
  // Review #187: Always scan globally to avoid missing multiple occurrences in a single file.
  // The previous approach (Review #184) only matched once for non-global patterns, which could
  // cause the security scanner to silently miss issues. Better to always find all matches.
