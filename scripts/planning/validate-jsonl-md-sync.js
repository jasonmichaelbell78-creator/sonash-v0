...
const normalize = (s) =>
  s
    ...
    .replaceAll(/ +$/gm, "") // strip trailing spaces only (tab-safe, avoids ReDoS on \s+)
    .trimEnd();
...
for (const gen of GENERATORS) {
  ...
  try {
    ...
    const dryRunIdx = freshMd.lastIndexOf("\n--- DRY RUN");
    const cleanFresh = dryRunIdx >= 0 ? freshMd.slice(0, dryRunIdx) : freshMd;
