...
These scripts contain parsing logic and edge-case handling that may be useful
as reference when maintaining the current pipeline. They are not wired into
any npm scripts or CI pipelines.
