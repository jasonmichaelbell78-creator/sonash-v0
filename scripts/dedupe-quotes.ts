...
export const newRecoveryQuotes: Quote[] = [
  ...
  {
    text: "Our common welfare should come first; personal recovery depends upon A.A. unity.",
    author: "Alcoholics Anonymous",
    source: "Twelve Traditions (Tradition One)",
  },
  {
    text: "Rarely have we seen a person fail who has thoroughly followed our path.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 5 'How It Works'",
  },
  {
  ...
  {
    text: "Those who do not recover are people who cannot or will not completely give themselves to this simple program…",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 5 'How It Works'",
  },
  {
    text: "If you have decided you want what we have and are willing to go to any length to get it—then you are ready to take certain steps.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 5 'How It Works'",
  },
  {
    text: "God could and would if He were sought.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 5 'How It Works'",
  },
  {
    text: "We claim spiritual progress rather than spiritual perfection.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 5 'How It Works'",
  },
  {
    text: "We alcoholics are men and women who have lost the ability to control our drinking.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 3 'More About Alcoholism'",
  },
  {
    text: "We are without defense against the first drink.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 3 'More About Alcoholism'",
  },
  {
    text: "Practical experience shows that nothing will so much insure immunity from drinking as intensive work with other alcoholics.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 7 'Working With Others'",
  },
  {
    text: "We will not regret the past nor wish to shut the door on it.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 6 'Into Action'",
  },
  {
    text: "Sometimes quickly, sometimes slowly.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 6 'Into Action'",
  },
  {
  ...
  {
    text: "We are not a glum lot.",
    author: "Alcoholics Anonymous",
    source: "Big Book, Ch. 9 'The Family Afterward'",
  },
  {
    text: "A great turning point in our lives came when we sought for humility as something we really wanted…",
    author: "Alcoholics Anonymous",
    source: "Twelve Steps & Twelve Traditions, Step Seven",
  },
  ...
  {
    text: "Lost dreams awaken and new possibilities arise.",
    author: "Narcotics Anonymous",
    source: "Basic Text",
  },
  {
    text: "There is no model of the recovering addict.",
    author: "Narcotics Anonymous",
    source: "Basic Text",
  },
  {
    text: "When the drugs go and the addict works the program, wonderful things happen.",
    author: "Narcotics Anonymous",
    source: "Basic Text",
  },
  ...
  {
    text: "We learned that we must live without drugs in order to live.",
    author: "Narcotics Anonymous",
    source: "Basic Text",
  },
  {
    text: "Just for today my thoughts will be on my recovery…",
    author: "Narcotics Anonymous",
  ...
  // Named authors (36-50)
  {
    text: "God, give us grace to accept with serenity the things that cannot be changed…",
    author: "Reinhold Niebuhr",
    source: "Serenity Prayer",
  },
  {
    text: "Spiritus contra spiritum. (spirit against spirit)",
    author: "Carl Jung",
  ...
  {
    text: "The mentality and behavior of drug addicts and alcoholics is wholly irrational…",
    author: "Russell Brand",
  },
  {
    text: "And so rock bottom became the solid foundation on which I rebuilt my life.",
    author: "J.K. Rowling",
  },
  {
    text: "Recovery is something that you have to work on every single day… it doesn't get a day off.",
    author: "Demi Lovato",
  },
  {
  ...
  {
    text: "Sobriety delivers what alcohol promises.",
    author: "Anonymous",
    source: "Recovery saying",
  },
  {
    text: "You can't think your way into right acting; you can act your way into right thinking.",
    author: "Anonymous",
    source: "Recovery saying",
  },
];
...
export const existingQuotes: Quote[] = [
  ...
  {
    text: "We are people who normally would not mix.",
    author: "Alcoholics Anonymous",
    source: "Big Book p. 17",
  },
  {
