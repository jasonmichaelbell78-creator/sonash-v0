            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, category: value as QuickLink["category"] })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
      ...
      <div className="space-y-6">
        {CATEGORIES.map((category) => {
          ...
          return (
            <div
              key={category.value}
              className="border border-amber-200 rounded-lg p-4 bg-amber-50/30"
            >
              <h3 className="font-semibold text-amber-900 mb-3">
                {category.label} ({categoryLinks.length})
              </h3>
