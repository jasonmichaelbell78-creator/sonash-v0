    ...
    <div className="space-y-4 py-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-[10px] text-gray-500">
          If set, this quote will appear on this specific date.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <select
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              scheduledTimeOfDay:
                (e.target.value as "morning" | "afternoon" | "evening" | undefined) || undefined,
            })
          }
        ...
        <p className="text-[10px] text-gray-500">
          Requires a scheduled date. Allows you to show different quotes for
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1 font-medium">
              ...
              {quote.source && (
                <span className="font-normal italic opacity-75"> ({quote.source})</span>
              )}
            </p>
            {quote.scheduledDate && (
