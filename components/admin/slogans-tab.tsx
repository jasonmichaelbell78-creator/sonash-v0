    ...
    <div className="space-y-4 py-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-[10px] text-gray-500">
          If set, this slogan will appear on this specific date.
        </p>
      </div>
      <div className="space-y-2">
        ...
        <select
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              scheduledTimeOfDay: e.target.value
        ...
        <p className="text-[10px] text-gray-500">
          Requires a scheduled date. Allows you to show different slogans for
