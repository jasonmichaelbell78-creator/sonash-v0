        ...
        >
            ...
            <div className="pr-6">
                ...
                <div className="flex items-baseline gap-1.5">
                    <span className="font-handlee text-2xl font-bold text-blue-900">
                        {timeRemaining}
                    </span>
                    <span className="font-handlee text-xs text-blue-600/60">
                        away
                    </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 mt-2">
                    ...
                    <span className="font-handlee text-xs text-blue-700/60">
                        Evening AA • Downtown
                    </span>
                </div>
            </div>
