...
const emptyStateContent = {
  journal: {
    ...
    message:
      "Every journey of recovery begins with a single step. Take a moment to reflect on your day — there's no wrong way to start.",
  ...
  meetings: {
    ...
    message:
      "Connection is a powerful part of recovery. When you're ready, there are people waiting to welcome you.",
  ...
  history: {
    ...
    message:
      "Your journal history will appear here as you write. Each entry is a milestone on your journey.",
...
export function EmptyState({ type, action }: Readonly<EmptyStateProps>) {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="font-heading text-xl text-amber-900 mb-3">{content.title}</h3>

      {/* Message */}
      <p className="font-body text-amber-800/70 max-w-xs mb-4 leading-relaxed">{content.message}</p>
