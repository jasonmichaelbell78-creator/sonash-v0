...
export function EntryWizard({ type, onClose }: EntryWizardProps) {
    ...
    const [inventory, setInventory] = useState({ resentments: "", dishonesty: "", apologies: "", successes: "" })
    ...
    const getTitle = () => {
        switch (type) {
            ...
            case 'gratitude': return "Gratitude List"
            case 'inventory': return "Nightly Inventory"
            case 'meeting-note': return "Meeting Note"
                ...
                <div className="p-6 space-y-6 flex-1 overflow-y-auto">
                    ...
                    {type === 'mood' && (
                        <div className="space-y-6 text-center">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-slate-500 uppercase tracking-widest">Intensity: {intensity}/10</label>
                                <input
                                    type="range"
                                    min="1" max="10"
                                    value={intensity}
                    ...
                    {type === 'gratitude' && (
                        <div className="space-y-4">
                            <p className="text-slate-500 italic text-center mb-4">"Gratitude unlocks the fullness of life."</p>
                    ...
                    {type === 'inventory' && (
                        <div className="space-y-4">
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-slate-400 uppercase">Resentments / Anger</label>
                                <textarea
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-slate-400 uppercase">Fear / Dishonesty</label>
                                <textarea
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-bold text-slate-400 uppercase">Successes / Wins</label>
                                <textarea
