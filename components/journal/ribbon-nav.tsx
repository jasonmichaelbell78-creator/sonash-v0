...
const ribbons = [
    { id: "crisis", color: "bg-red-500", hoverColor: "hover:bg-red-600", label: "Crisis", icon: AlertTriangle, description: "Spot checks" },
    { id: "gratitude", color: "bg-emerald-500", hoverColor: "hover:bg-emerald-600", label: "Gratitude", icon: Heart, description: "Gratitude lists" },
