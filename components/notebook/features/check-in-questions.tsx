  ...
  return (
    <div className="space-y-3 pl-1" role="group" aria-label="Daily check-in questions">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3" role="radiogroup" aria-labelledby="cravings-label">
          <button
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3" role="radiogroup" aria-labelledby="used-label">
          <button
