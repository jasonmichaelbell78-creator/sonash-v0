                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {step === "sponsor" && (
                            <motion.div
                                ...
                                className="space-y-6"
                            >
                                <h2 className="font-rocksalt text-2xl text-stone-800 text-center">Do you have a sponsor?</h2>
                                <p className="font-handlee text-lg text-stone-600 text-center">
                                    A sponsor helps guide you through recovery. <br />
                                    <span className="text-sm text-stone-400">(This helps us personalize your experience)</span>
                                </p>
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <>
                                                        ...
                                                        <h3 className="font-rocksalt text-xl text-stone-800 mb-2">{slide.title}</h3>
                                ...
                                <div className="flex justify-center gap-2">
                                    {tourSlides.map((_, i) => (
                                        <button
                                            ...
                                            className={`w-2 h-2 rounded-full transition-colors ${tourSlide === i ? "bg-stone-800" : "bg-stone-300"
                                                }`}
                                        />
                                    ))}
                                </div>
