...
This document provides a point-in-time snapshot of SonarCloud analysis results,
capturing issue counts, severity distribution, hotspot categories, and a
detailed cleanup plan for remediation.
...
| ----- | -------- | -------- | -------------------------------------- |
| S7772 | 56       | 37       | `require('fs')` → `require('node:fs')` |
