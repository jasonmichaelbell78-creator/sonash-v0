...
**Document Version:** 9.3 **Created:** 2026-01-02 **Last Updated:** 2026-01-18
...
| ------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 9.3     | 2026-01-18 | Review #178: PR #277 Soft-Delete + Error Export - 5 items (2 MAJOR: URL exposure in error-export.ts fixed with redactSensitiveUrl() stripping query params/hash, UID logging in jobs.ts replaced uid.slice(0,8) with hashUserId(); 3 MINOR: whitespace trim on DELETE confirmation input, consistent hashUserId usage across all logging). **KEY LESSON: window.location.href includes query params that may contain tokens/session IDs - always strip to origin+pathname for error reports.**                                                                                                                                                                                                                                                                                             |
