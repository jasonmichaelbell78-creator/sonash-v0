...
**Document Version:** 17.32 **Created:** 2026-01-02 **Last Updated:** 2026-02-17
...
<details>
<summary>Versions 17.21 and earlier (click to expand)</summary>
...
| **3**  | Active Reviews (#285-347)                                                                                                                                                                                                                                                                                                                    | Deep investigation            | ~2400 lines |
...
| ------------------- | ------------- | --------- | --------------------------------------------------------------------------------- |
| Main log lines      | ~3400         | 1500      | Archive oldest reviews (OVERDUE — see audit note below)                           |
| Active reviews      | 63 (#285-347) | 20        | Archive oldest active reviews until ≤20 remain (even if consolidation is current) |
| Quick Index entries | ~25           | 50        | Prune or categorize                                                               |

> **Audit Note (2026-02-17):** Main log exceeds threshold by 2x. Recommend
> archiving reviews #285-334 to `docs/archive/REVIEWS_285-334.md`. Quick Index
> references only reviews #1-51 (all archived) — needs refresh with recent
> patterns from PRs #366-#370.
