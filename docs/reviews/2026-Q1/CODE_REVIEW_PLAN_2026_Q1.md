...
This document serves as the **execution plan** for running a multi-AI code quality review on SoNash. Use this template when:
...
- **Step 4.1 Complete**: Updated 6 audit templates, created FIREBASE_CHANGE_POLICY.md
...
Secondary: scripts/ (developer tooling)
Exclude: docs/, public/, node_modules/, .next/, dist/, dist-tests/
...
You are the Implementation Engineer for a single PR in a Next.js repo. You are executing one PR from a deduped refactor plan.
