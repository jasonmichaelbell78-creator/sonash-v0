...
> **Note:** The `validate:canon` npm script will be added in Step 5 (Task 5.10).
> Until then, use the direct script path:
> `node scripts/validate-canon-schema.js`
...
> **Note:** The `normalize:canon` npm script will be added in Step 5 (Task
> 5.10). Until then, use the direct script path:
> `node scripts/normalize-canon-ids.js`
...
**Document Version:** 1.0 **Task Status:** COMPLETE
