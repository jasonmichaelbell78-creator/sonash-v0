...
**Root Cause:** Inconsistent "../" depth calculation when creating docs in
nested directories.
...
**Root Cause:** Templates contain [X] placeholders that weren't replaced during
instantiation.
...
**Required Fields (per DOCUMENTATION_STANDARDS.md):** Document Version, Applies
To
