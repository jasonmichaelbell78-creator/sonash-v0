...
Step 4 produces:
- **DEDUPED_FINDINGS_JSONL**: Unified CANON items with severity (S0-S3) and effort (E0-E3)
- **PR_PLAN_JSON**: Staged, prioritized PRs grouped by file overlap
- **HUMAN_SUMMARY**: Top wins, high-risk items, cross-cutting findings

This step executes those findings. Without it, the audit produces a backlog that never gets addressed.
