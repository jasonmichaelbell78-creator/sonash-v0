...
This document serves as the **execution plan** for running a multi-AI large-scale refactoring audit on [Project Name]. Use this template when:
...
You are a senior TypeScript/[Framework] engineer performing a REFACTORING audit on a repository. Your #1 priority is identifying cross-cutting duplication and inconsistency patterns that need consolidation.
