...
| MASTER-0068 | No npm run dev:offline script - requires 2 termina...  | S2       | E0     | dx            | dx-improvements          |
| MASTER-0069 | No scripts/doctor.js for environment validation        | S2       | E1     | dx            | dx-improvements          |
| MASTER-0075 | No Firebase persistence enabled - Firestore cache ...  | S1       | E1     | offline       | offline-support          |
...
| 60   | MASTER-0068 | No npm run dev:offline script - requires...  | S2  | E0     | 100   | dx            |
| 61   | MASTER-0069 | No scripts/doctor.js for environment val...  | S2  | E1     | 100   | dx            |
| 62   | MASTER-0070 | Setup requires multiple commands - no si...  | S3  | E0     | 100   | dx            |
| 63   | MASTER-0071 | No correlation IDs for request tracing (...  | S1  | E2     | 100   | code          |
| 64   | MASTER-0072 | 8:1 ratio of console.log to structured l...  | S2  | E2     | 100   | code          |
| 65   | MASTER-0074 | No offline write queue - data loss when ...  | S1  | E3     | 100   | offline       |
| 66   | MASTER-0075 | No Firebase persistence enabled - Firest...  | S1  | E1     | 100   | offline       |
| 67   | MASTER-0076 | No service worker - no offline asset cac...  | S2  | E2     | 100   | offline       |
