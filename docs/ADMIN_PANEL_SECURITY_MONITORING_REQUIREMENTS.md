...
- [M1.6 Admin Panel Phase 4](../ROADMAP.md#phase-4-error-tracking---sentry-integration--complete-via-track-a) -
  Error Tracking
- [M1.6 Admin Panel Phase 5](../ROADMAP.md#phase-5-system-logs---gcp-integration--complete-via-track-a) -
  Logs Tab
