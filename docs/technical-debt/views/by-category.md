...
| DEBT-2808 | Date formats inconsistent across the app                       | S2       | multiple                                                                     | 0    |
| DEBT-2809 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | S2       | multiple                                                                     | 0    |
| DEBT-2811 | Documentation effectiveness metrics - no tracking of whic...   | S2       | multiple                                                                     | 0    |
| DEBT-2812 | Add engines field to root package.json for CI/CD consistency   | S2       | 1-165                                                                        | 0    |
| DEBT-2813 | Missing ARIA labels on critical navigation tabs                | S2       | multiple                                                                     | 0    |
...
| DEBT-2961 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | S2       | multiple                                                                     | 0    |
| DEBT-2962 | Documentation effectiveness metrics - no tracking of whic...   | S2       | multiple                                                                     | 0    |
| DEBT-2963 | Add engines field to root package.json for CI/CD consistency   | S2       | 1-165                                                                        | 0    |
| DEBT-2964 | Date formats inconsistent across the app                       | S2       | multiple                                                                     | 0    |
| DEBT-2965 | Missing ARIA labels on critical navigation tabs                | S2       | multiple                                                                     | 0    |
| DEBT-2966 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | S2       | docs/technical-debt/views/by-status.md                                       | 0    |
| DEBT-2967 | Documentation effectiveness metrics - no tracking of whic...   | S2       | docs/README.md                                                               | 0    |
| DEBT-2968 | Add engines field to root package.json for CI/CD consistency   | S2       | package.json                                                                 | 0    |
| DEBT-2969 | Date formats inconsistent across the app                       | S2       | lib/utils/date-utils.ts                                                      | 0    |
...
| DEBT-2393 | Gap: Missing overview for multi-ai audit system                | S2       | docs/audits/multi-ai/README.md                                     | 0    |
...
| DEBT-2077 | AUDIT_TRACKER.md has Status in Purpose line instead of me...   | S3       | docs/audits/AUDIT_TRACKER.md                                       | 0    |
| DEBT-2078 | Structure: AUDIT_TRACKER.md should be Tier 4 Operational       | S3       | docs/audits/AUDIT_TRACKER.md                                       | 0    |
...
| DEBT-2083 | Broken anchor link: ../technical-debt/PROCEDURE.md#11-cat...   | S3       | docs/audits/multi-ai/COORDINATOR.md                                | 0    |
...
| DEBT-2179 | Broken internal link: path.md                                  | S3       | docs/audits/multi-ai/templates/DOCUMENTATION_AUDIT.md              | 0    |
...
| DEBT-2430 | Diagram opportunity: Multi-AI audit workflow lacks visual...   | S3       | docs/audits/multi-ai/README.md                                     | 0    |
| DEBT-2431 | Navigation: Multi-AI audit templates lack consistent cros...   | S3       | docs/audits/multi-ai/templates/CODE_REVIEW_PLAN.md                 | 0    |
