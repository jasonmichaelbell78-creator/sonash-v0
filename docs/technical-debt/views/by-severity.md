...
| DEBT-2849 | Date formats inconsistent across the app                       | multiple                                                                     | 0    | code-quality             | E1     |
| DEBT-2846 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | multiple                                                                     | 0    | code-quality             | E1     |
| DEBT-2847 | Documentation effectiveness metrics - no tracking of whic...   | multiple                                                                     | 0    | code-quality             | E2     |
| DEBT-2848 | Add engines field to root package.json for CI/CD consistency   | 1-165                                                                        | 0    | code-quality             | E0     |
| DEBT-2845 | Missing ARIA labels on critical navigation tabs                | multiple                                                                     | 0    | code-quality             | E0     |
...
| DEBT-2933 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | multiple                                                                     | 0    | code-quality             | E1     |
| DEBT-2934 | Documentation effectiveness metrics - no tracking of whic...   | multiple                                                                     | 0    | code-quality             | E2     |
| DEBT-2935 | Add engines field to root package.json for CI/CD consistency   | 1-165                                                                        | 0    | code-quality             | E0     |
| DEBT-2936 | Date formats inconsistent across the app                       | multiple                                                                     | 0    | code-quality             | E1     |
| DEBT-2937 | Missing ARIA labels on critical navigation tabs                | multiple                                                                     | 0    | code-quality             | E0     |
| DEBT-2938 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | docs/technical-debt/views/by-status.md                                       | 0    | code-quality             | E1     |
| DEBT-2939 | Documentation effectiveness metrics - no tracking of whic...   | docs/README.md                                                               | 0    | code-quality             | E2     |
| DEBT-2940 | Add engines field to root package.json for CI/CD consistency   | package.json                                                                 | 0    | code-quality             | E0     |
| DEBT-2941 | Date formats inconsistent across the app                       | lib/utils/date-utils.ts                                                      | 0    | code-quality             | E1     |
| DEBT-2852 | session-start.js outputs 40+ decorative lines with emoji ...   | .claude/hooks/session-start.js                                               | 0    | code-quality             | E1     |
| DEBT-2853 | Multi-line regex with greedy [\s\S]\*? quantifier in auto-...  | .claude/hooks/auto-save-context.js                                           | 0    | code-quality             | E1     |
| DEBT-2856 | Fragile markdown field parsing regex repeated across 3+ s...   | .claude/hooks/commit-tracker.js                                              | 0    | code-quality             | E1     |
...
| DEBT-2850 | TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md marked COMPLETE ...   | docs/plans/TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md                | 0    | code-quality  | E0     |
| DEBT-2851 | SESSION_HISTORY.md and SESSION_DECISIONS.md not in DOCUME...   | docs/SESSION_HISTORY.md                                            | 0    | code-quality  | E0     |
| DEBT-2854 | JSONL line counting pattern repeated 5x without abstraction    | .claude/hooks/session-start.js                                     | 0    | code-quality  | E0     |
| DEBT-2855 | String concatenation for file paths instead of path.join       | scripts/archive-doc.js                                             | 0    | code-quality  | E0     |
| DEBT-2857 | Hooks output decorative error messages instead of machine...   | .claude/hooks/auto-save-context.js                                 | 0    | code-quality  | E2     |
| DEBT-2858 | Unused fields in commit-log.jsonl state file                   | .claude/state/commit-log.jsonl                                     | 0    | code-quality  | E0     |
