...
| DEBT-2865 | PostToolUse Write: 10 sequential hook processes spawned p... | .claude/settings.json | 0 | code-quality | E2 |
| DEBT-2866 | PostToolUse Edit: 9 sequential hook processes spawned per... | .claude/settings.json | 0 | code-quality | E2 |
| DEBT-2990 | PostToolUse Write: 10 sequential hook processes spawned p... | .claude/settings.json | 0 | ai-optimization | E2 |
| DEBT-3017 | ROADMAP.md milestone tracking tables | ROADMAP.md | 0 | code-quality | E2 |
| DEBT-3018 | AUDIT_TRACKER.md audit log tables | docs/AUDIT_TRACKER.md | 0 | code-quality | E2 |
| DEBT-3019 | EXPANSION_EVALUATION_TRACKER.md decision log with 280 ideas | docs/EXPANSION_EVALUATION_TRACKER.md | 0 | code-quality | E3 |
| DEBT-3020 | AUDIT_TRACKER.md threshold matrix and version history | docs/AUDIT_TRACKER.md | 0 | code-quality | E2 |
| DEBT-3040 | sync-claude-settings.js - Unused Claude Code settings syn... | scripts/sync-claude-settings.js | 0 | code-quality | E1 |
| DEBT-3042 | Write/Edit/MultiEdit share 8 redundant hooks (~530ms over... | .claude/settings.json | 0 | code-quality | E2 |
| DEBT-3044 | check-write-requirements vs check-edit-requirements dupli... | .claude/hooks/check-write-requirements.js, .claude/hooks/check-edit-requirements.js | 0 | code-quality | E1 |
| DEBT-3049 | audit-s0s1-validator.js only triggers on audit files but ... | .claude/hooks/audit-s0s1-validator.js | 0 | code-quality | E3 |
| DEBT-3050 | Read hooks have no execution order guarantee - context tr... | .claude/hooks/large-context-warning.js, .claude/hooks/auto-save-context.js, .claude/hooks/compaction-handoff.js | 0 | code-quality | E2 |
| DEBT-3057 | Multiple audit skills with overlapping domain coverage | .claude/skills/audit-*/SKILL.md | 0 | code-quality | E1 |
| DEBT-3059 | Senior specialist skills vs audit-comprehensive coverage | .claude/skills/senior-*/SKILL.md | 0 | code-quality | E1 |
| DEBT-3063 | Unclear relationship: audit-validation-wrapper vs audit-c... | .claude/skills/audit-validation-wrapper/SKILL.md | 0 | code-quality | E1 |
| DEBT-3067 | Audit skill explosion: 9 audit-related skills with incons... | .claude/skills/audit-*/SKILL.md | 0 | code-quality | E2 |
| DEBT-3071 | Deprecated or unclear purpose: artifacts-builder, markitd... | .claude/skills/artifacts-builder/SKILL.md, markitdown/SKILL.md, mcp-builder/SKILL.md, expansion-evaluation/SKILL.md, systematic-debugging/SKILL.md | 0 | code-quality | E1 |
| DEBT-3072 | 57 documents with duplicate/inconsistent AI Instructions ... | docs/**/*.md, SESSION_CONTEXT.md, AUDIT_TRACKER.md, PLAN_MAP.md (and 54 others) | 0 | code-quality | E2 |
| DEBT-3073 | AI Instructions placement violates own DOCUMENTATION_STAN... | docs/DOCUMENTATION_STANDARDS.md, docs/APPCHECK_SETUP.md, docs/INCIDENT_RESPONSE.md, docs/SONARCLOUD_CLEANUP_RUNBOOK.md (and others) | 0 | code-quality | E1 |
| DEBT-3082 | AUDIT_FINDINGS_BACKLOG.md markdown parsing in check-backl... | scripts/check-backlog-health.js | 0 | code-quality | E2 |
| DEBT-3083 | Markdown table parsing in update-readme-status.js with pi... | scripts/update-readme-status.js | 0 | code-quality | E2 |
| DEBT-3084 | check-session-gaps.js relies on hardcoded Session Context... | scripts/check-session-gaps.js | 0 | code-quality | E1 |
| DEBT-3085 | aggregate-audit-findings.js markdown parsing fragility in... | scripts/aggregate-audit-findings.js | 0 | code-quality | E2 |
| DEBT-3086 | generate-pending-alerts.js fragile DEFERRED item extraction | scripts/generate-pending-alerts.js | 0 | code-quality | E1 |
| DEBT-3091 | HOOKIFY_STRATEGY.md - 1.1KB implementation plan unused | docs/HOOKIFY_STRATEGY.md | 0 | code-quality | E0 |
| DEBT-3099 | FIX_TEMPLATES.md - 0 outbound refs for Qodo PR fixes | docs/agent_docs/FIX_TEMPLATES.md | 0 | code-quality | E0 |
...
| DEBT-3182 | session-start.js uses execSync with shell:true — subproce... | .claude/hooks/session-start.js | 0 | ai-optimization | E1 |
| DEBT-3183 | SessionStart uses stacked synchronous subprocesses across... | .claude/settings.json | 0 | ai-optimization | E1 |
| DEBT-3202 | session-start.js outputs 400-600 tokens of verbose status... | .claude/hooks/session-start.js | 0 | ai-optimization | E2 |
| DEBT-3203 | SessionStart critical path runs multiple heavyweight sync... | .claude/hooks/session-start.js | 0 | ai-optimization | E2 |
| DEBT-3204 | Hook Latency: Unconditional test build | .claude/hooks/session-start.js | 0 | ai-optimization | E2 |
| DEBT-3205 | SessionStart runs 4 sequential Node process spawns — 4-8s... | .claude/settings.json | 0 | ai-optimization | E2 |
| DEBT-3206 | COMMAND_REFERENCE.md is 109KB — loaded on demand but risk... | .claude/COMMAND_REFERENCE.md | 0 | ai-optimization | E2 |
| DEBT-3207 | Session-start hook uses execSync for version checks that ... | .claude/hooks/session-start.js | 0 | ai-optimization | E2 |
...
| DEBT-1119 | The '__proto__' property is deprecated. | scripts/audit/validate-audit-integration.js | 195 | code-quality | E0 |
...
| DEBT-2833 | Audit all manual CLI tools and add to COMMAND_REFERENCE.md | .claude/COMMAND_REFERENCE.md | 0 | documentation | E1 |
| DEBT-2834 | Composite validator: consolidate 9 PostToolUse hooks into... | .claude/settings.json | 57 | engineering-productivity | E3 |
| DEBT-2835 | OPT-P004: update-readme-status.js table parsing requires ... | scripts/update-readme-status.js | 156 | code-quality | E2 |
| DEBT-2836 | OPT-P006: aggregate-audit-findings.js fragile markdown pa... | scripts/aggregate-audit-findings.js | 322 | code-quality | E2 |
| DEBT-2840 | Add automatic ROADMAP.md completion detection | scripts/ | 0 | process | E2 |
| DEBT-2859 | doc-optimizer SKILL.md has duplicated CRITICAL RETURN PRO... | .claude/skills/doc-optimizer/SKILL.md | 0 | code-quality | E2 |
| DEBT-2860 | Audit skills share >50% boilerplate content without share... | .claude/skills/audit-comprehensive/SKILL.md | 0 | code-quality | E2 |
| DEBT-2862 | SessionStart: session-start.js spawns 6+ sequential execS... | .claude/hooks/session-start.js | 0 | code-quality | E2 |
| DEBT-2863 | SessionStart: check-remote-session-context.js runs git fe... | .claude/hooks/check-remote-session-context.js | 0 | code-quality | E1 |
| DEBT-2867 | PostToolUse Read: 3 hooks with redundant file reads and s... | .claude/hooks/large-context-warning.js | 0 | code-quality | E1 |
| DEBT-2868 | compaction-handoff.js uses execSync (shell) instead of ex... | .claude/hooks/compaction-handoff.js | 0 | code-quality | E0 |
| DEBT-2870 | Duplicate file content reads across PostToolUse hooks | .claude/hooks/firestore-write-block.js | 0 | code-quality | E1 |
| DEBT-2873 | UserPromptSubmit: 4 hooks run on every user message inclu... | .claude/hooks/alerts-reminder.js | 0 | code-quality | E1 |
| DEBT-2878 | Skill overlap: sonarcloud-sprint is superseded by sonarcloud | .claude/skills/sonarcloud-sprint/SKILL.md | 0 | code-quality | E1 |
| DEBT-2882 | Skill overlap: ui-design-system vs ux-researcher-designer... | .claude/skills/ui-design-system/SKILL.md | 0 | code-quality | E2 |
| DEBT-2886 | Orphaned skill: find-skills not in SKILL_INDEX.md | .claude/skills/find-skills/SKILL.md | 0 | code-quality | E0 |
| DEBT-2887 | Orphaned skill: pre-commit-fixer not in SKILL_INDEX.md | .claude/skills/pre-commit-fixer/SKILL.md | 0 | code-quality | E0 |
| DEBT-2888 | Orphaned skill: task-next not in SKILL_INDEX.md | .claude/skills/task-next/SKILL.md | 0 | code-quality | E0 |
| DEBT-2889 | Orphaned skill: multi-ai-audit not in SKILL_INDEX.md | .claude/skills/multi-ai-audit/SKILL.md | 0 | code-quality | E0 |
| DEBT-2890 | Orphaned skill: add-debt not in SKILL_INDEX.md | .claude/skills/add-debt/SKILL.md | 0 | code-quality | E0 |
| DEBT-2891 | Orphaned skill: verify-technical-debt not in SKILL_INDEX.md | .claude/skills/verify-technical-debt/SKILL.md | 0 | code-quality | E0 |
| DEBT-2892 | Orphaned skill: pr-retro not in SKILL_INDEX.md | .claude/skills/pr-retro/SKILL.md | 0 | code-quality | E0 |
| DEBT-2893 | Orphaned skill: sonarcloud not in SKILL_INDEX.md (only so... | .claude/skills/sonarcloud/SKILL.md | 0 | code-quality | E0 |
| DEBT-2894 | Orphaned skill: test-suite not in SKILL_INDEX.md | .claude/skills/test-suite/SKILL.md | 0 | code-quality | E0 |
| DEBT-2896 | Agent prompts in audit-process lack CRITICAL RETURN PROTOCOL | .claude/skills/audit-process/SKILL.md | 0 | code-quality | E1 |
| DEBT-2898 | Agent prompts in audit-documentation lack explicit JSONL ... | .claude/skills/audit-documentation/SKILL.md | 0 | code-quality | E1 |
| DEBT-2899 | Agent prompts in audit-enhancements reference subagent wi... | .claude/skills/audit-enhancements/SKILL.md | 0 | code-quality | E1 |
| DEBT-2900 | FALSE_POSITIVES.jsonl not referenced in audit-process or ... | .claude/skills/audit-process/SKILL.md | 0 | code-quality | E1 |
| DEBT-2903 | MCP memory server configured but not enabled - 3 skills h... | .mcp.json | 0 | code-quality | E1 |
| DEBT-2904 | MCP filesystem server duplicates native Claude Code Read/... | .mcp.json | 0 | code-quality | E1 |
| DEBT-2910 | session-begin SKILL.md reads ROADMAP.md (3164 lines) in f... | .claude/skills/session-begin/SKILL.md | 0 | code-quality | E1 |
| DEBT-2912 | session-begin reads Technical Debt INDEX.md + AI_WORKFLOW... | .claude/skills/session-begin/SKILL.md | 0 | code-quality | E1 |
| DEBT-2914 | pr-review SKILL.md is 840 lines loaded entirely when skil... | .claude/skills/pr-review/SKILL.md | 0 | code-quality | E2 |
| DEBT-2915 | audit-comprehensive SKILL.md is 854 lines loaded entirely... | .claude/skills/audit-comprehensive/SKILL.md | 0 | code-quality | E2 |
| DEBT-2917 | alerts-reminder.js injects context-consuming messages on ... | .claude/hooks/alerts-reminder.js | 0 | code-quality | E1 |
| DEBT-2921 | commit-log.jsonl has no rotation/size-cap logic (39KB, ap... | .claude/state/commit-log.jsonl | 0 | code-quality | E1 |
| DEBT-2922 | handoff.json embeds full commitLog array (25KB, unbounded... | .claude/state/handoff.json | 0 | code-quality | E1 |
| DEBT-2956 | HookRunner framework — centralized hook orchestration wit... | .claude/hooks/post-write-validator.js | 0 | refactoring | E3 |
| DEBT-2957 | Hook project dir escape: cwdInsideProject allows parent d... | N/A | 0 | security | E1 |
| DEBT-2960 | Symlink file overwrite in rotate-state.js rotation/prunin... | .claude/hooks/lib/rotate-state.js | 25 | security | E1 |
| DEBT-2965 | Missing ARIA labels on critical navigation tabs | multiple | 0 | code-quality | E0 |
| DEBT-2966 | Stale documentation markers - 96 TODO/TBD occurrences acr... | multiple | 0 | code-quality | E1 |
| DEBT-2967 | Documentation effectiveness metrics - no tracking of whic... | multiple | 0 | code-quality | E2 |
| DEBT-2968 | Add engines field to root package.json for CI/CD consistency | 1-165 | 0 | code-quality | E0 |
| DEBT-2969 | Date formats inconsistent across the app | multiple | 0 | code-quality | E1 |
| DEBT-2972 | session-start.js outputs 40+ decorative lines with emoji ... | .claude/hooks/session-start.js | 0 | code-quality | E1 |
| DEBT-2973 | Multi-line regex with greedy [\s\S]*? quantifier in auto-... | .claude/hooks/auto-save-context.js | 0 | code-quality | E1 |
| DEBT-2976 | Fragile markdown field parsing regex repeated across 3+ s... | .claude/hooks/commit-tracker.js | 0 | code-quality | E1 |
| DEBT-2979 | External link checker has ~100% false positive rate | scripts/check-external-links.js | 0 | engineering-productivity | E1 |
| DEBT-2980 | Commit tracker shows 212h stale despite recent commits | .claude/hooks/commit-tracker.js | 0 | engineering-productivity | E1 |
| DEBT-2981 | Automate archival of completed ROADMAP.md items to ROADMA... | scripts/ | 0 | process | E2 |
| DEBT-2984 | Stale documentation markers - 96 TODO/TBD occurrences acr... | docs/technical-debt/views/by-status.md | 0 | code-quality | E1 |
| DEBT-2985 | Documentation effectiveness metrics - no tracking of whic... | docs/README.md | 0 | code-quality | E2 |
| DEBT-2986 | Add engines field to root package.json for CI/CD consistency | package.json | 0 | code-quality | E0 |
| DEBT-2987 | Date formats inconsistent across the app | lib/utils/date-utils.ts | 0 | code-quality | E1 |
| DEBT-2989 | Audit skills share >50% boilerplate content without share... | .claude/skills/audit-comprehensive/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-2991 | compaction-handoff.js uses execSync (shell) instead of ex... | .claude/hooks/compaction-handoff.js | 0 | ai-optimization | E0 |
| DEBT-2993 | UserPromptSubmit: 4 hooks run on every user message inclu... | .claude/hooks/alerts-reminder.js | 0 | ai-optimization | E1 |
| DEBT-2997 | Skill overlap: sonarcloud-sprint is superseded by sonarcloud | .claude/skills/sonarcloud-sprint/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-2998 | Orphaned skill: find-skills not in SKILL_INDEX.md | .claude/skills/find-skills/SKILL.md | 0 | ai-optimization | E0 |
| DEBT-3000 | Agent prompts in audit-process lack CRITICAL RETURN PROTOCOL | .claude/skills/audit-process/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3001 | FALSE_POSITIVES.jsonl not referenced in audit-process or ... | .claude/skills/audit-process/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3004 | MCP filesystem server duplicates native Claude Code Read/... | .mcp.json | 0 | ai-optimization | E1 |
| DEBT-3007 | session-begin SKILL.md reads ROADMAP.md (3164 lines) in f... | .claude/skills/session-begin/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3008 | pr-review SKILL.md is 840 lines loaded entirely when skil... | .claude/skills/pr-review/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-3009 | audit-comprehensive SKILL.md is 854 lines loaded entirely... | .claude/skills/audit-comprehensive/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-3011 | alerts-reminder.js injects context-consuming messages on ... | .claude/hooks/alerts-reminder.js | 0 | ai-optimization | E1 |
| DEBT-3014 | commit-log.jsonl has no rotation/size-cap logic (39KB, ap... | .claude/state/commit-log.jsonl | 0 | ai-optimization | E1 |
| DEBT-3015 | handoff.json embeds full commitLog array (25KB, unbounded... | .claude/state/handoff.json | 0 | ai-optimization | E1 |
| DEBT-3021 | DOCUMENT_DEPENDENCIES.md sync status tracking | docs/DOCUMENT_DEPENDENCIES.md | 0 | code-quality | E2 |
| DEBT-3022 | SESSION_CONTEXT.md quick status table | SESSION_CONTEXT.md | 0 | code-quality | E1 |
| DEBT-3023 | DOCUMENT_DEPENDENCIES.md cross-document update triggers m... | docs/DOCUMENT_DEPENDENCIES.md | 0 | code-quality | E2 |
| DEBT-3024 | ROADMAP.md detailed milestone specifications embedded | ROADMAP.md | 0 | code-quality | E2 |
| DEBT-3025 | PR_WORKFLOW_CHECKLIST.md version history table | docs/PR_WORKFLOW_CHECKLIST.md | 0 | code-quality | E1 |
| DEBT-3026 | EXPANSION_EVALUATION_TRACKER.md command reference table | docs/EXPANSION_EVALUATION_TRACKER.md | 0 | code-quality | E2 |
| DEBT-3031 | ai-review.js - Unused AI review prompt applicator | scripts/ai-review.js | 0 | code-quality | E0 |
| DEBT-3033 | create-canonical-findings.js - Unused canonical findings ... | scripts/create-canonical-findings.js | 0 | code-quality | E1 |
| DEBT-3034 | generate-pending-alerts.js - Unused session-start alert g... | scripts/generate-pending-alerts.js | 0 | code-quality | E0 |
| DEBT-3036 | migrate-existing-findings.js - Unused legacy findings mig... | scripts/migrate-existing-findings.js | 0 | code-quality | E1 |
| DEBT-3038 | regenerate-findings-index.js - Unused canonical findings ... | scripts/regenerate-findings-index.js | 0 | code-quality | E1 |
| DEBT-3041 | update-legacy-lines.js - Unused legacy findings line numb... | scripts/update-legacy-lines.js | 0 | code-quality | E1 |
| DEBT-3045 | agent-trigger-enforcer.js runs on every code file edit wi... | .claude/hooks/agent-trigger-enforcer.js | 0 | code-quality | E2 |
| DEBT-3046 | Three Read hooks contend for .context-tracking-state.json... | .claude/hooks/large-context-warning.js, .claude/hooks/auto-save-context.js, .claude/hooks/compaction-handoff.js | 0 | code-quality | E2 |
| DEBT-3047 | State file sprawl across .claude/hooks/ and .claude/state/ | .claude/state/, .claude/hooks/ | 0 | code-quality | E1 |
| DEBT-3048 | validation hooks could share file read to reduce I/O | .claude/hooks/component-size-check.js, firestore-write-block.js, test-mocking-validator.js, app-check-validator.js, typescript-strict-check.js, repository-pattern-check.js | 0 | code-quality | E2 |
| DEBT-3053 | session-start.js does heavy work at SessionStart (builds,... | .claude/hooks/session-start.js | 0 | code-quality | E2 |
| DEBT-3054 | Auto-save-context hook reads 4 files per Read operation t... | .claude/hooks/auto-save-context.js | 0 | code-quality | E1 |
| DEBT-3056 | SessionStart hook chain is sequential with no paralleliza... | .claude/hooks/session-start.js | 0 | code-quality | E2 |
| DEBT-3058 | Skill overlap: docs-sync vs docs-update vs doc-optimizer | .claude/skills/docs-sync/SKILL.md, docs-update/SKILL.md, doc-optimizer/SKILL.md | 0 | code-quality | E1 |
| DEBT-3060 | Empty or minimal SKILL.md descriptions | .claude/skills/[multiple]/SKILL.md | 0 | code-quality | E0 |
| DEBT-3061 | Skill overlap: debt tracking skills (add-deferred-debt, a... | .claude/skills/add-deferred-debt/SKILL.md, add-manual-debt/SKILL.md, verify-technical-debt/SKILL.md, sync-sonarcloud-debt/SKILL.md | 0 | code-quality | E1 |
| DEBT-3062 | Skill overlap: PR and review skills (pr-review, pr-retro,... | .claude/skills/pr-review/SKILL.md, pr-retro/SKILL.md, code-reviewer/SKILL.md, requesting-code-review/SKILL.md | 0 | code-quality | E1 |
| DEBT-3065 | Potential deprecation: skill-creator, skill-related skill... | .claude/skills/skill-creator/SKILL.md, find-skills/SKILL.md | 0 | code-quality | E1 |
| DEBT-3068 | Skill naming inconsistency: enhancement vs audit-enhancem... | .claude/skills/audit-enhancements/SKILL.md, audit-process/SKILL.md | 0 | code-quality | E1 |
| DEBT-3069 | Marketing-focused skills in technical codebase (content-r... | .claude/skills/content-research-writer/SKILL.md, market-research-reports/SKILL.md, ux-researcher-designer/SKILL.md | 0 | code-quality | E0 |
| DEBT-3070 | Undefined skill descriptions create discovery problem (50... | .claude/skills/*/SKILL.md | 0 | code-quality | E1 |
| DEBT-3074 | Redundant App Check instructions across 3 documents | docs/APPCHECK_SETUP.md, docs/RECAPTCHA_REMOVAL_GUIDE.md, claude.md | 0 | code-quality | E2 |
| DEBT-3075 | Outdated IMS references in SESSION_HISTORY.md and AI_REVI... | docs/SESSION_HISTORY.md (lines 25-50), docs/AI_REVIEW_LEARNINGS_LOG.md (lines with 'IMS→TDMS'), docs/AUDIT_TRACKER.md (version 2.6-2.7) | 0 | code-quality | E1 |
| DEBT-3087 | check-roadmap-health.js version parsing regex scoped to s... | scripts/check-roadmap-health.js | 0 | code-quality | E1 |
| DEBT-3088 | Multi-AI normalize-format.js markdown table detection and... | scripts/multi-ai/normalize-format.js | 0 | code-quality | E2 |
| DEBT-3089 | verify-sonar-phase.js hardcoded security section header d... | scripts/verify-sonar-phase.js | 0 | code-quality | E1 |
| DEBT-3092 | RECAPTCHA_REMOVAL_GUIDE.md - 745 lines about Firebase con... | docs/RECAPTCHA_REMOVAL_GUIDE.md | 0 | code-quality | E0 |
| DEBT-3093 | REVIEW_POLICY_INDEX.md - 370 lines index without inbound ... | docs/REVIEW_POLICY_INDEX.md | 0 | code-quality | E0 |
| DEBT-3094 | PLAN_MAP.md - 242 lines documentation hierarchy map never... | docs/PLAN_MAP.md | 0 | code-quality | E0 |
| DEBT-3095 | MCP_SERVER_AUDIT.md - 374 lines about MCP consumption nev... | docs/MCP_SERVER_AUDIT.md | 0 | code-quality | E0 |
| DEBT-3100 | SKILL_AGENT_POLICY.md - 0 refs despite defining usage policy | docs/agent_docs/SKILL_AGENT_POLICY.md | 0 | code-quality | E0 |
| DEBT-3101 | Audit inventory stage files (6 files) - generated but unr... | docs/audits/single-session/process/audit-2026-02-09/stage-1*.md | 0 | code-quality | E0 |
| DEBT-3103 | Plan documents with zero inbound refs - 5 planning files ... | docs/plans/CI_GATES_BLOCKING_PLAN.md and 4 others | 0 | code-quality | E0 |
| DEBT-3106 | No automated SKILL_INDEX.md sync — 9 orphaned skills disc... | .claude/skills/SKILL_INDEX.md | 0 | ai-optimization | E2 |
| DEBT-3113 | velocity-log.jsonl has malformed sprint field data | .claude/state/velocity-log.jsonl | 0 | ai-optimization | E1 |
| DEBT-3117 | .session-state.json shows 166 begins vs 16 ends (10:1 ratio) | .claude/hooks/.session-state.json | 0 | ai-optimization | E1 |
| DEBT-3118 | session-start.js hook outputs ~50 lines of checklist text... | .claude/hooks/session-start.js | 0 | ai-optimization | E1 |
...
| DEBT-3184 | Dead Script: dedupe-quotes.ts | scripts/dedupe-quotes.ts | 0 | ai-optimization | E0 |
| DEBT-3185 | Dead Script: enrich-addresses.ts | scripts/enrich-addresses.ts | 0 | ai-optimization | E0 |
| DEBT-3186 | Dead Script: import-nashville-links.ts | scripts/import-nashville-links.ts | 0 | ai-optimization | E0 |
| DEBT-3187 | Dead Script: migrate-library-content.ts | scripts/migrate-library-content.ts | 0 | ai-optimization | E0 |
| DEBT-3188 | Dead Script: migrate-meetings-dayindex.ts | scripts/migrate-meetings-dayindex.ts | 0 | ai-optimization | E0 |
| DEBT-3189 | Dead Script: migrate-to-journal.ts | scripts/migrate-to-journal.ts | 0 | ai-optimization | E0 |
| DEBT-3190 | Dead Script: seed-meetings.ts | scripts/seed-meetings.ts | 0 | ai-optimization | E0 |
| DEBT-3191 | Dead Script: seed-real-data.ts | scripts/seed-real-data.ts | 0 | ai-optimization | E0 |
| DEBT-3192 | Dead Script: seed-sober-living-data.ts | scripts/seed-sober-living-data.ts | 0 | ai-optimization | E0 |
| DEBT-3193 | Dead Script: set-admin-claim.ts | scripts/set-admin-claim.ts | 0 | ai-optimization | E0 |
| DEBT-3194 | Dead Script: sync-geocache.ts | scripts/sync-geocache.ts | 0 | ai-optimization | E0 |
| DEBT-3195 | Dead Script: test-geocode.ts | scripts/test-geocode.ts | 0 | ai-optimization | E0 |
| DEBT-3196 | Dead Script: retry-failures.ts | scripts/retry-failures.ts | 0 | ai-optimization | E0 |
| DEBT-3197 | session-start.js spawns 2 unnecessary child processes for... | .claude/hooks/session-start.js | 0 | ai-optimization | E0 |
| DEBT-3198 | session-start.sh (365 lines) is dead code — replaced by s... | .claude/hooks/session-start.sh | 0 | ai-optimization | E0 |
| DEBT-3199 | stop-serena-dashboard.js runs every SessionStart despite ... | .claude/hooks/stop-serena-dashboard.js | 0 | ai-optimization | E0 |
| DEBT-3200 | Shell hooks (.sh) are dead code — replaced by .js equival... | .claude/hooks/session-start.sh | 0 | ai-optimization | E0 |
| DEBT-3201 | Agent sub-prompts omit evidence field from output schema | .claude/skills/audit-ai-optimization/SKILL.md | 0 | ai-optimization | E0 |
| DEBT-3208 | Dead Documentation: Code Review Checklist references | .claude/skills/code-reviewer/SKILL.md | 140 | ai-optimization | E1 |
| DEBT-3209 | Fragile Parsing: Git output parsing in post-read-handler.js | .claude/hooks/post-read-handler.js | 0 | ai-optimization | E1 |
| DEBT-3210 | AI Instruction Bloat: audit-code SKILL.md | .claude/skills/audit-code/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3211 | check-edit-requirements.sh and check-write-requirements.s... | .claude/hooks/check-edit-requirements.sh | 0 | ai-optimization | E1 |
| DEBT-3212 | post-write-validator.js and pattern-check.js share identi... | .claude/hooks/post-write-validator.js | 0 | ai-optimization | E1 |
| DEBT-3213 | Multiple hooks contain duplicated gitExec helper function | .claude/hooks/post-read-handler.js | 0 | ai-optimization | E1 |
| DEBT-3214 | Context Optimization: Heavy episodic memory search | .claude/skills/audit-code/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3215 | Pre-commit subagent Task prompt is under-specified for de... | .claude/skills/pre-commit-fixer/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3216 | CRITICAL Persistence Rules boilerplate copy-pasted across... | .claude/skills/audit-ai-optimization/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3217 | hook-warnings-log.jsonl has repetitive low-value entries ... | .claude/state/hook-warnings-log.jsonl | 0 | ai-optimization | E1 |
| DEBT-3218 | Legacy shell hook scripts appear runtime-unused (possibly... | .claude/hooks/analyze-user-request.sh | 0 | ai-optimization | E1 |
| DEBT-3219 | 13 consolidated-out hook JS files remain as dead standalo... | .claude/hooks/agent-trigger-enforcer.js | 0 | ai-optimization | E1 |
| DEBT-3220 | Task() sub-agents dont check FALSE_POSITIVES.jsonl before... | .claude/skills/audit-ai-optimization/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3221 | stop-serena-dashboard.js uses 6+ execFileSync calls at se... | .claude/hooks/stop-serena-dashboard.js | 0 | ai-optimization | E1 |
| DEBT-3222 | Scripts not in package.json: add-false-positive.js, assig... | scripts/add-false-positive.js | 0 | ai-optimization | E1 |
| DEBT-3223 | Hooks use string manipulation where JSON.parse should be ... | .claude/hooks/state-utils.js | 0 | ai-optimization | E1 |
| DEBT-3224 | Audit skill prompts may not consistently reference FALSE_... | .claude/skills/audit-ai-optimization/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3226 | Skill Overlap: audit-code vs code-reviewer | .claude/skills/audit-code/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-3230 | Subprocess Overhead: Node spawning in hooks | .claude/hooks/session-start.js | 0 | ai-optimization | E2 |
| DEBT-3232 | SKILL.md file exceeds 500 lines with duplicated boilerplate | .claude/skills/audit-ai-optimization/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-3235 | Audit skill templates have high duplication and could be ... | .claude/skills/audit-code/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-3236 | Session-start hook is 505 lines with inline prompts >10 l... | .claude/hooks/session-start.js | 0 | ai-optimization | E2 |
| DEBT-3237 | State JSONL files growing without bounds - reviews.jsonl ... | .claude/state/reviews.jsonl | 0 | ai-optimization | E2 |
| DEBT-3240 | Skills read entire large files when only headers/sections... | .claude/skills/session-begin/ | 0 | ai-optimization | E2 |
| DEBT-3241 | doc-optimizer and audit-process SKILL.md exceed 1500 line... | .claude/skills/doc-optimizer/SKILL.md | 0 | ai-optimization | E2 |
| DEBT-3242 | 10 audit skills share >50% identical structure without sh... | .claude/skills/audit-code/SKILL.md | 0 | ai-optimization | E3 |
...
| DEBT-1996 | Markdownlint and Prettier checks not confirmed | docs/**/*.md | 1 | documentation | E1 |
...
| DEBT-2012 | Broken internal link: docs/archive/completed-plans/TRACK_... | ROADMAP.md | 0 | documentation | E1 |
| DEBT-2013 | Broken internal link: docs/archive/completed-plans/TRACK_... | ROADMAP.md | 0 | documentation | E1 |
| DEBT-2014 | Broken internal link: ./docs/archive/SoNash__AdminPanelEn... | ROADMAP.md | 0 | documentation | E1 |
...
| DEBT-2019 | Broken internal link: docs/archive/completed-plans/TRACK_... | SESSION_CONTEXT.md | 0 | documentation | E1 |
...
| DEBT-2161 | Broken internal link: ./archive/SoNash__AdminPanelEnhance... | docs/ADMIN_PANEL_SECURITY_MONITORING_REQUIREMENTS.md | 0 | documentation | E1 |
| DEBT-2162 | Broken internal link: ./archive/SoNash__AdminPanelEnhance... | docs/ADMIN_PANEL_SECURITY_MONITORING_REQUIREMENTS.md | 0 | documentation | E1 |
...
| DEBT-2182 | Broken internal link: ./archive/2025-dec-reports/BILLING_... | docs/SECURITY.md | 0 | documentation | E1 |
| DEBT-2183 | Broken internal link: ./archive/2025-dec-reports/BILLING_... | docs/SECURITY.md | 0 | documentation | E1 |
| DEBT-2184 | Broken internal link: ./archive/2025-dec-reports/BILLING_... | docs/SECURITY.md | 0 | documentation | E1 |
...
| DEBT-2214 | Broken internal link: docs/archive/2025-dec-reports/CODE_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2241 | Broken internal link: docs/archive/Monetization_Research_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2253 | Broken internal link: docs/archive/SoNash__AdminPanelEnha... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2254 | Broken internal link: docs/archive/SoNash__AdminPanelEnha... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2255 | Broken internal link: docs/archive/SoNash__AdminPanelEnha... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2256 | Broken internal link: docs/archive/SoNash__Phase1_ClaudeC... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2257 | Broken internal link: docs/archive/SoNash__Phase1_ClaudeC... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2258 | Broken internal link: docs/archive/SoNash__Phase1_ClaudeC... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2265 | Broken internal link: docs/archive/completed-plans/EIGHT_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2266 | Broken internal link: docs/archive/completed-plans/INTEGR... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
| DEBT-2267 | Broken internal link: docs/archive/completed-plans/TRACK_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2301 | Broken internal link: docs/archive/legacy_task_list_2025_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2305 | Broken internal link: docs/archive/source-data/nashville_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2308 | Broken internal link: docs/archive/superseded-plans/M1.6_... | DOCUMENTATION_INDEX.md | 0 | documentation | E1 |
...
| DEBT-2861 | pattern-check.js has inline pattern definitions that coul... | .claude/hooks/pattern-check.js | 0 | code-quality | E1 |
| DEBT-2864 | SessionStart: stop-serena-dashboard.js spawns PowerShell ... | .claude/hooks/stop-serena-dashboard.js | 0 | code-quality | E1 |
| DEBT-2869 | agent-trigger-enforcer.js loads external config via requi... | .claude/hooks/agent-trigger-enforcer.js | 0 | code-quality | E1 |
| DEBT-2871 | large-context-warning.js reads entire file just to count ... | .claude/hooks/large-context-warning.js | 0 | code-quality | E0 |
| DEBT-2872 | check-edit-requirements.js and check-write-requirements.j... | .claude/hooks/check-edit-requirements.js | 0 | code-quality | E0 |
| DEBT-2874 | pre-compaction-save.js calls 7 git subprocess operations ... | .claude/hooks/pre-compaction-save.js | 0 | code-quality | E1 |
| DEBT-2875 | commit-tracker.js spawns 4 git subprocesses on commit det... | .claude/hooks/commit-tracker.js | 0 | code-quality | E1 |
| DEBT-2876 | pattern-check.js calls fs.realpathSync twice (file and pr... | .claude/hooks/pattern-check.js | 0 | code-quality | E0 |
| DEBT-2877 | alerts-reminder.js reads 4 JSON files synchronously on ev... | .claude/hooks/alerts-reminder.js | 0 | code-quality | E1 |
| DEBT-2879 | Skill overlap: code-reviewer listed in two SKILL_INDEX ca... | .claude/skills/SKILL_INDEX.md | 0 | code-quality | E0 |
| DEBT-2880 | Skill overlap: senior-fullstack listed in two SKILL_INDEX... | .claude/skills/SKILL_INDEX.md | 0 | code-quality | E0 |
| DEBT-2881 | Skill overlap: frontend-design vs senior-frontend have ov... | .claude/skills/frontend-design/SKILL.md | 0 | code-quality | E2 |
| DEBT-2883 | Skill overlap: senior-qa vs webapp-testing vs test-suite ... | .claude/skills/senior-qa/SKILL.md | 0 | code-quality | E2 |
| DEBT-2884 | Skill overlap: checkpoint vs save-context both preserve s... | .claude/skills/checkpoint/SKILL.md | 0 | code-quality | E1 |
| DEBT-2885 | Skill overlap: docs-sync vs docs-update both handle docum... | .claude/skills/docs-sync/SKILL.md | 0 | code-quality | E1 |
| DEBT-2895 | SKILL_INDEX.md claims 55 total skills but count is inaccu... | .claude/skills/SKILL_INDEX.md | 0 | code-quality | E0 |
| DEBT-2897 | Agent prompts in audit-process Stage 1 use markdown outpu... | .claude/skills/audit-process/SKILL.md | 0 | code-quality | E2 |
| DEBT-2901 | pre-commit-fixer agent prompts are generic category dispa... | .claude/skills/pre-commit-fixer/SKILL.md | 0 | code-quality | E1 |
| DEBT-2902 | MCP git server configured but unused and redundant with n... | .mcp.json | 0 | code-quality | E0 |
| DEBT-2905 | MCP github server enabled but not configured - redundant ... | .claude/settings.local.json | 0 | code-quality | E0 |
| DEBT-2906 | 7 mcp__filesystem__ permissions approved in settings.loca... | .claude/settings.local.json | 0 | code-quality | E0 |
| DEBT-2907 | 3 mcp__serena__ permissions approved but serena is in dis... | .claude/settings.local.json | 0 | code-quality | E0 |
| DEBT-2908 | MCP global template includes puppeteer which conflicts wi... | .claude/mcp.global-template.json | 0 | code-quality | E0 |
| DEBT-2909 | MCP firebase server enabled but not configured - may rely... | .claude/settings.local.json | 0 | code-quality | E0 |
| DEBT-2911 | session-begin instructs reading CODE_PATTERNS.md (600 lin... | .claude/skills/session-begin/SKILL.md | 0 | code-quality | E1 |
| DEBT-2913 | compact-restore.js injects full recovery context even whe... | .claude/hooks/compact-restore.js | 0 | code-quality | E1 |
| DEBT-2916 | Edit and MultiEdit hook lists are identical 9-hook copies... | .claude/settings.json | 0 | code-quality | E1 |
| DEBT-2918 | analyze-user-request.js high-confidence matches inject di... | .claude/hooks/analyze-user-request.js | 0 | code-quality | E1 |
| DEBT-2919 | session-begin SKILL.md is 361 lines with redundant hook-a... | .claude/skills/session-begin/SKILL.md | 0 | code-quality | E1 |
| DEBT-2920 | code-reviewer SKILL.md contains generic boilerplate not s... | .claude/skills/code-reviewer/SKILL.md | 0 | code-quality | E1 |
| DEBT-2923 | reviews.jsonl has no rotation (19KB, 30+ entries, thresho... | .claude/state/reviews.jsonl | 0 | code-quality | E1 |
| DEBT-2951 | Add symlink audit trail logging to atomic write helpers | .claude/hooks/lib/rotate-state.js | 0 | security | E1 |
| DEBT-2952 | Add integration tests for hook consolidation (post-write-... | .claude/hooks/post-write-validator.js | 0 | code-quality | E2 |
| DEBT-2953 | Add audit logging for state file rotation events | .claude/hooks/lib/rotate-state.js | 0 | process | E1 |
| DEBT-2954 | Add error boundary tests for hook failure isolation | .claude/hooks/post-write-validator.js | 0 | code-quality | E1 |
| DEBT-2955 | Document atomic write pattern as reusable helper | docs/agent_docs/CODE_PATTERNS.md | 0 | documentation | E0 |
| DEBT-2958 | Hook scripts lack durable audit trail logging | N/A | 0 | process | E2 |
| DEBT-2959 | Hook validators log code snippets that could expose secrets | N/A | 0 | security | E1 |
| DEBT-2970 | TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md marked COMPLETE ... | docs/plans/TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md | 0 | code-quality | E0 |
| DEBT-2971 | SESSION_HISTORY.md and SESSION_DECISIONS.md not in DOCUME... | docs/SESSION_HISTORY.md | 0 | code-quality | E0 |
| DEBT-2974 | JSONL line counting pattern repeated 5x without abstraction | .claude/hooks/session-start.js | 0 | code-quality | E0 |
| DEBT-2975 | String concatenation for file paths instead of path.join | scripts/archive-doc.js | 0 | code-quality | E0 |
| DEBT-2977 | Hooks output decorative error messages instead of machine... | .claude/hooks/auto-save-context.js | 0 | code-quality | E2 |
| DEBT-2978 | Unused fields in commit-log.jsonl state file | .claude/state/commit-log.jsonl | 0 | code-quality | E0 |
| DEBT-2982 | Add validation that completed ROADMAP items have been arc... | scripts/check-roadmap-health.js | 0 | process | E1 |
| DEBT-2983 | Add bidirectional SESSION_CONTEXT.md ↔ ROADMAP.md sync va... | scripts/check-cross-doc-deps.js | 0 | process | E1 |
| DEBT-2988 | TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md marked COMPLETE ... | docs/plans/TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md | 0 | ai-optimization | E0 |
| DEBT-2992 | check-edit-requirements.js and check-write-requirements.j... | .claude/hooks/check-edit-requirements.js | 0 | ai-optimization | E0 |
| DEBT-2994 | pre-compaction-save.js calls 7 git subprocess operations ... | .claude/hooks/pre-compaction-save.js | 0 | ai-optimization | E1 |
| DEBT-2995 | commit-tracker.js spawns 4 git subprocesses on commit det... | .claude/hooks/commit-tracker.js | 0 | ai-optimization | E1 |
| DEBT-2996 | pattern-check.js calls fs.realpathSync twice (file and pr... | .claude/hooks/pattern-check.js | 0 | ai-optimization | E0 |
| DEBT-2999 | SKILL_INDEX.md claims 55 total skills but count is inaccu... | .claude/skills/SKILL_INDEX.md | 0 | ai-optimization | E0 |
| DEBT-3002 | pre-commit-fixer agent prompts are generic category dispa... | .claude/skills/pre-commit-fixer/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3003 | MCP git server configured but unused and redundant with n... | .mcp.json | 0 | ai-optimization | E0 |
| DEBT-3005 | 7 mcp__filesystem__ permissions approved in settings.loca... | .claude/settings.local.json | 0 | ai-optimization | E0 |
| DEBT-3006 | 3 mcp__serena__ permissions approved but serena is in dis... | .claude/settings.local.json | 0 | ai-optimization | E0 |
| DEBT-3010 | Edit and MultiEdit hook lists are identical 9-hook copies... | .claude/settings.json | 0 | ai-optimization | E1 |
| DEBT-3012 | analyze-user-request.js high-confidence matches inject di... | .claude/hooks/analyze-user-request.js | 0 | ai-optimization | E1 |
| DEBT-3013 | code-reviewer SKILL.md contains generic boilerplate not s... | .claude/skills/code-reviewer/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3016 | reviews.jsonl has no rotation (19KB, 30+ entries, thresho... | .claude/state/reviews.jsonl | 0 | ai-optimization | E1 |
| DEBT-3027 | SESSION_CONTEXT.md recent session summaries | SESSION_CONTEXT.md | 0 | code-quality | E1 |
| DEBT-3028 | PLAN_MAP.md version history table | docs/PLAN_MAP.md | 0 | code-quality | E1 |
| DEBT-3029 | AI_REVIEW_LEARNINGS_LOG.md large append-only learning jou... | docs/AI_REVIEW_LEARNINGS_LOG.md | 0 | code-quality | E2 |
| DEBT-3030 | ROADMAP_LOG.md completed items history (31KB, 1,129 lines) | ROADMAP_LOG.md | 0 | code-quality | E1 |
| DEBT-3032 | check-review-triggers.sh - Dead shell script for multi-AI... | scripts/check-review-triggers.sh | 0 | code-quality | E0 |
| DEBT-3035 | generate-placement-report.js - Unused roadmap placement s... | scripts/generate-placement-report.js | 0 | code-quality | E1 |
| DEBT-3037 | redeploy-admin-dashboard.sh - Firebase deployment helper ... | scripts/redeploy-admin-dashboard.sh | 0 | code-quality | E2 |
| DEBT-3039 | seed-commit-log.js - One-time commit log backfill utility | scripts/seed-commit-log.js | 0 | code-quality | E0 |
| DEBT-3051 | Bash hook (commit-tracker) does fast-path regex on every ... | .claude/hooks/commit-tracker.js | 0 | code-quality | E1 |
| DEBT-3052 | check-write-requirements and check-edit-requirements coul... | .claude/hooks/check-write-requirements.js, .claude/hooks/check-edit-requirements.js | 0 | code-quality | E1 |
| DEBT-3055 | TypeScript strict check runs on every Write/Edit/MultiEdi... | .claude/hooks/typescript-strict-check.js | 0 | code-quality | E1 |
| DEBT-3064 | Placeholder skills with minimal utility (using-superpower... | .claude/skills/using-superpowers/SKILL.md, task-next/SKILL.md, validate-claude-folder/SKILL.md | 0 | code-quality | E0 |
| DEBT-3066 | Session lifecycle skills (session-begin, session-end, che... | .claude/skills/session-begin/SKILL.md, session-end/SKILL.md, checkpoint/SKILL.md | 0 | code-quality | E0 |
| DEBT-3076 | Inconsistent AI Instructions format across document tiers | docs/*.md (all 57 files) | 0 | code-quality | E1 |
| DEBT-3077 | Disconnected AI Instructions from actual automation - TES... | docs/TESTING_PLAN.md, docs/SONARCLOUD_CLEANUP_RUNBOOK.md, docs/RECAPTCHA_REMOVAL_GUIDE.md | 0 | code-quality | E2 |
| DEBT-3078 | AI Instructions in SESSION_CONTEXT.md creates circular re... | SESSION_CONTEXT.md, AI_WORKFLOW.md, ROADMAP.md | 0 | code-quality | E1 |
| DEBT-3096 | MCP_SETUP.md - 178 lines configuration guide without trac... | docs/MCP_SETUP.md | 0 | code-quality | E0 |
| DEBT-3097 | LEARNING_METRICS.md - 84 lines metrics tracking document | docs/LEARNING_METRICS.md | 0 | code-quality | E0 |
| DEBT-3098 | AUTOMATION_AUDIT_REPORT.md - 255 lines audit results neve... | docs/AUTOMATION_AUDIT_REPORT.md | 0 | code-quality | E0 |
| DEBT-3102 | ADR template and decisions/README - decision framework un... | docs/decisions/ | 0 | code-quality | E0 |
| DEBT-3107 | No pre-commit check for FALSE_POSITIVES.jsonl integration... | .claude/skills/audit-process/SKILL.md | 0 | ai-optimization | E1 |
| DEBT-3109 | warned-files.json grows unbounded (4KB, 48 entries, no ex... | .claude/state/warned-files.json | 0 | ai-optimization | E1 |
| DEBT-3110 | task-audit-template-overhaul.state.json is stale (7 days,... | .claude/state/task-audit-template-overhaul.state.json | 0 | ai-optimization | E0 |
| DEBT-3111 | override-log.jsonl has no rotation or size cap | .claude/override-log.jsonl | 0 | ai-optimization | E1 |
| DEBT-3112 | agent-invocations.jsonl has no rotation or size cap | .claude/state/agent-invocations.jsonl | 0 | ai-optimization | E1 |
| DEBT-3114 | .claude/tmp-alerts.json persists across sessions (temp fi... | .claude/tmp-alerts.json | 0 | ai-optimization | E0 |
| DEBT-3115 | session-end does not clean .session-agents.json or .agent... | .claude/skills/session-end/SKILL.md | 0 | ai-optimization | E0 |
| DEBT-3116 | MEMORY.md is within size limits but contains completed/st... | C:/Users/jason/.claude/projects/C--Users-jason-Workspace-dev-projects-sonash-v0/memory/MEMORY.md | 0 | ai-optimization | E0 |
| DEBT-3119 | compact-restore.js injects full recovery context (~30 lin... | .claude/hooks/compact-restore.js | 0 | ai-optimization | E1 |
| DEBT-3121 | 3 hooks on every Read operation add latency without conte... | .claude/settings.json | 0 | ai-optimization | E1 |
...
| DEBT-3225 | filesystem MCP server configured but permanently disabled... | .mcp.json | 0 | ai-optimization | E0 |
| DEBT-3227 | Dead Documentation: technical-debt/INDEX.md | docs/technical-debt/INDEX.md | 0 | ai-optimization | E0 |
| DEBT-3228 | MCP Config Efficiency: Unused filesystem server | .mcp.json | 0 | ai-optimization | E0 |
| DEBT-3229 | Format Waste: Verbose session-start output | .claude/hooks/session-start.js | 0 | ai-optimization | E1 |
| DEBT-3231 | Dead Documentation: technical-debt/logs artifacts | docs/technical-debt/logs/verification-log.jsonl | 0 | ai-optimization | E0 |
| DEBT-3233 | settings.json disabledMcpjsonServers has 3 stale entries ... | .claude/settings.json | 0 | ai-optimization | E0 |
| DEBT-3234 | Session-begin checklist duplicates mandatory context reads | .claude/skills/session-begin/SKILL.md | 0 | ai-optimization | E0 |
| DEBT-3238 | session-start.js reads full reviews.jsonl for a single co... | .claude/hooks/session-start.js | 0 | ai-optimization | E0 |
| DEBT-3239 | MCP servers configured but 4 are disabled — disabled list... | .claude/settings.json | 0 | ai-optimization | E0 |
| DEBT-3243 | Multiple hooks duplicate loadJson/saveJson atomic write p... | .claude/hooks/post-read-handler.js | 0 | ai-optimization | E1 |
| DEBT-3244 | health-score-log.jsonl and hook-warnings-log.jsonl grow u... | .claude/state/health-score-log.jsonl | 0 | ai-optimization | E1 |
| DEBT-3245 | Remote-branch parsing relies on delimiter split that can ... | .claude/hooks/check-remote-session-context.js | 0 | ai-optimization | E1 |
| DEBT-3246 | Shell script hooks may be redundant with Node.js versions | .claude/hooks/session-start.sh | 0 | ai-optimization | E1 |
