...
| DEBT-2808 | Date formats inconsistent across the app                       | multiple                                                                     | 0         | code-quality             | E1     |
| DEBT-2809 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | multiple                                                                     | 0         | code-quality             | E1     |
| DEBT-2811 | Documentation effectiveness metrics - no tracking of whic...   | multiple                                                                     | 0         | code-quality             | E2     |
| DEBT-2812 | Add engines field to root package.json for CI/CD consistency   | 1-165                                                                        | 0         | code-quality             | E0     |
| DEBT-2813 | Missing ARIA labels on critical navigation tabs                | multiple                                                                     | 0         | code-quality             | E0     |
...
| DEBT-2833 | Audit all manual CLI tools and add to COMMAND_REFERENCE.md     | .claude/COMMAND_REFERENCE.md                                                 | null      | documentation            | E1     |
...
| DEBT-2837 | Add automatic ROADMAP.md completion detection                  | scripts/                                                                     | 0         | process                  | E2     |
| DEBT-2838 | Automate archival of completed ROADMAP.md items to ROADMA...   | scripts/                                                                     | 0         | process                  | E2     |
| DEBT-2961 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | multiple                                                                     | 0         | code-quality             | E1     |
| DEBT-2962 | Documentation effectiveness metrics - no tracking of whic...   | multiple                                                                     | 0         | code-quality             | E2     |
| DEBT-2963 | Add engines field to root package.json for CI/CD consistency   | 1-165                                                                        | 0         | code-quality             | E0     |
| DEBT-2964 | Date formats inconsistent across the app                       | multiple                                                                     | 0         | code-quality             | E1     |
| DEBT-2965 | Missing ARIA labels on critical navigation tabs                | multiple                                                                     | 0         | code-quality             | E0     |
| DEBT-2966 | Stale documentation markers - 96 TODO/TBD occurrences acr...   | docs/technical-debt/views/by-status.md                                       | 0         | code-quality             | E1     |
| DEBT-2967 | Documentation effectiveness metrics - no tracking of whic...   | docs/README.md                                                               | 0         | code-quality             | E2     |
| DEBT-2968 | Add engines field to root package.json for CI/CD consistency   | package.json                                                                 | 0         | code-quality             | E0     |
| DEBT-2969 | Date formats inconsistent across the app                       | lib/utils/date-utils.ts                                                      | 0         | code-quality             | E1     |
| DEBT-2944 | session-start.js outputs 40+ decorative lines with emoji ...   | .claude/hooks/session-start.js                                               | 0         | code-quality             | E1     |
| DEBT-2945 | Multi-line regex with greedy [\s\S]\*? quantifier in auto-...  | .claude/hooks/auto-save-context.js                                           | 0         | code-quality             | E1     |
| DEBT-2948 | Fragile markdown field parsing regex repeated across 3+ s...   | .claude/hooks/commit-tracker.js                                              | 0         | code-quality             | E1     |
...
| DEBT-2957 | Hook project dir escape: cwdInsideProject allows parent d...   | N/A                                                                          | undefined | security                 | E1     |
...
| DEBT-2839 | Add validation that completed ROADMAP items have been arc...   | scripts/check-roadmap-health.js                                    | 0         | process       | E1     |
| DEBT-2840 | Add bidirectional SESSION_CONTEXT.md ↔ ROADMAP.md sync va...   | scripts/check-cross-doc-deps.js                                    | 0         | process       | E1     |
| DEBT-2942 | TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md marked COMPLETE ...   | docs/plans/TECHNICAL_DEBT_MANAGEMENT_SYSTEM_PLAN.md                | 0         | code-quality  | E0     |
| DEBT-2943 | SESSION_HISTORY.md and SESSION_DECISIONS.md not in DOCUME...   | docs/SESSION_HISTORY.md                                            | 0         | code-quality  | E0     |
| DEBT-2946 | JSONL line counting pattern repeated 5x without abstraction    | .claude/hooks/session-start.js                                     | 0         | code-quality  | E0     |
| DEBT-2947 | String concatenation for file paths instead of path.join       | scripts/archive-doc.js                                             | 0         | code-quality  | E0     |
| DEBT-2949 | Hooks output decorative error messages instead of machine...   | .claude/hooks/auto-save-context.js                                 | 0         | code-quality  | E2     |
| DEBT-2950 | Unused fields in commit-log.jsonl state file                   | .claude/state/commit-log.jsonl                                     | 0         | code-quality  | E0     |
...
| DEBT-2906 | 7 mcp**filesystem** permissions approved in settings.loca...   | .claude/settings.local.json                                        | 0         | code-quality  | E0     |
| DEBT-2907 | 3 mcp**serena** permissions approved but serena is in dis...   | .claude/settings.local.json                                        | 0         | code-quality  | E0     |
...
| DEBT-2958 | Hook scripts lack durable audit trail logging                  | N/A                                                                | undefined | process       | E2     |
| DEBT-2959 | Hook validators log code snippets that could expose secrets    | N/A                                                                | undefined | security      | E1     |
