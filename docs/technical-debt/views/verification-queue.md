...
| DEBT-2813 | Date formats inconsistent across the app                     | S2       | src/components                                                                       | 0    |
| DEBT-3247 | Triage 96 stale TODO/TBD markers across 34 files             | S2       | src                                                                                  | 0    |
| DEBT-3248 | Documentation effectiveness metrics — track which docs ar... | S2       | docs                                                                                 | 0    |
| DEBT-3249 | Add engines field to root package.json for CI/CD consistency | S2       | package.json                                                                         | 0    |
| DEBT-3250 | Missing ARIA labels on critical navigation tabs              | S2       | src/components                                                                       | 0    |
...
| DEBT-3253 | Dead Documentation: Code Review Checklist references         | S2       | 140                                                                                  | 0    |
...
| DEBT-3254 | Filesystem MCP server configured but noted as unused         | S3       | .mcp.json                                                                            | 0    |
