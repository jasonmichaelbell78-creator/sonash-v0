...
import { CelebrationProvider, useCelebration } from '@/components/celebrations/celebration-provider'
import { CelebrationType, CELEBRATION_MESSAGES, CELEBRATION_INTENSITY_MAP } from '@/components/celebrations/types'
            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        Click any event below to preview the celebration animation. Different events trigger different intensity levels.
                    </p>
                </motion.div>
                ...
                >
                    <p className="mb-2">
                        💡 <strong>Tip:</strong> Animations auto-dismiss after 2-6 seconds depending on intensity.
                    </p>
                    <p>
                        🎊 The 1-year milestone includes special fireworks! Try it out.
                    </p>
                </motion.div>
            </div>
        </main>
