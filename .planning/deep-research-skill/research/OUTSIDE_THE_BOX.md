...
- **How it differs from current thinking:** The QUALITY_EVALUATION report covers
  recency as a quality dimension, but treats it as "newer is better."
  Time-travel research treats the _evolution_ of understanding as itself
...
- **Application to deep research:** When the research discovers conflicting
  ...
  DOMAIN_AGNOSTIC_DESIGN report, but goes deeper: the system should actively
  seek _disconfirming_ evidence for its preliminary findings, not just
