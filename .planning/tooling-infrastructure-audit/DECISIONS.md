...
**KEEP (5 project):** nextjs-architecture-expert, react-performance-optimization, security-auditor, code-reviewer, documentation-expert

**REMOVE (19 project):** database-architect, fullstack-developer, security-engineer, deployment-engineer, devops-troubleshooter, mcp-expert, backend-architect, debugger, error-detective, frontend-developer, penetration-tester, technical-writer, ui-ux-designer, dependency-manager, markdown-syntax-formatter, test-engineer, performance-engineer, prompt-engineer, git-flow-manager
