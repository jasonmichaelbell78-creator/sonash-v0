...
1. **Knowledge base not ready**:
   `.planning/system-wide-standardization/reference/framework-repo/` was
   archived (per Q33 — redundant with CANON decisions). No navigation index.
   Agent-research reference material missing.
