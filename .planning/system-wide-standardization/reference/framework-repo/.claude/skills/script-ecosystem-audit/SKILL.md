...
description: |
  ...
  interactive finding-by-finding walkthrough. Covers scripts for module
...
```json
{
  ...
  "fixesApplied": ["added try/catch to affected script"],
  "findingsData": []
}
```
...
| Source              | Path                    | Content                           |
| ------------------- | ----------------------- | --------------------------------- |
| Script source code  | `scripts/**/*.js`       | Script implementations            |
