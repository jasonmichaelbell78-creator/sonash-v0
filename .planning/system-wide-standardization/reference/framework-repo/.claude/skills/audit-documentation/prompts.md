...
Verify: ROADMAP item refs, PR/Issue refs, skill/hook path refs. Output
`${AUDIT_DIR}/stage-2-cross-refs.jsonl`. Return ONLY:
...
Check terminology consistency, duplicate content (exact >50 words and fuzzy 80%+),
contradictions. Output `${AUDIT_DIR}/stage-3-coherence.jsonl`. Return ONLY:
