...
3. **Assign to refactoring track** - Dedicated refactoring milestone
...
cat "${AUDIT_DIR}/COMPREHENSIVE_AUDIT_REPORT.md"

# Check for false positives to exclude
cat docs/technical-debt/FALSE_POSITIVES.jsonl
```
...
| ------------------------ | --------------------------- | ------- | --------- |
| security                 | any                         | Track-S | current   |
| performance              | any                         | Track-P | current   |
| process                  | any                         | Track-D | upcoming  |
| refactoring              | any                         | REF     | upcoming  |
| documentation            | any                         | DOCS    | current   |
| engineering-productivity | any                         | Track-E | upcoming  |
| code-quality             | scripts/, .claude/          | Track-E | upcoming  |
| code-quality             | .github/                    | Track-D | upcoming  |
| code-quality             | tests/                      | Track-T | upcoming  |
| code-quality             | src/backend/, functions/    | BACKEND | upcoming  |
| code-quality             | src/                        | CORE    | upcoming  |
| enhancements             | any                         | ENH     | future    |
| ai-optimization          | .claude/skills/, .claude/\* | Track-E | upcoming  |
...
Finding: Improve error handling across API routes
  ...
  Files: src/api/*.ts (13 files)
  Auto-assignment: CORE (main source track)

Manual override: Track-D (Developer Experience track)
Reason: This is a systemic process improvement, not feature-specific
...
3. **Assign to docs milestone** - Documentation milestone
