...
description: Verify and triage technical debt items - classify, then place into ROADMAP
  sprints
---
...
| refactoring    | Architecture or GRAND PLAN         |
...
GRAND PLAN Sprint 6 (Testing):
  - DEBT-2764: Missing integration tests (S2)
...
- `sprint` - Work through sprint items
