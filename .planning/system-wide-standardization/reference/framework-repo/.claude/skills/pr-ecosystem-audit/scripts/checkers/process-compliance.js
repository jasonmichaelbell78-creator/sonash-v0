...
function checkSkillInvocationFidelity(reviewsJsonl, learningsContent, findings) {
  ...
  const stepKeywords = [
    ...
    'static analysis', // Step 3: static analysis integration
    'review tool', // Step 4: review tool integration
...
function _computeKeywordPct(reviews, keywords, defaultPct) {
  ...
  // eslint-disable-next-line framework/no-unsafe-division -- guarded by reviews.length === 0 check above
