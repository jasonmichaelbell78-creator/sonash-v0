 ...
 *   node run-tdms-ecosystem-audit.js --batch   # Suppress state writes (for iterative fixing)
 *   node run-tdms-ecosystem-audit.js --save-baseline  # Save current scores as baseline
 *
