...
7. **Defer findings** using the "Defer for later" option — log to session file
...
- Defer — add to deferred list for later
...
1. Log the finding to the deferred list in the session file
2. Note the finding with its severity and impact score
3. Log decision to session file
