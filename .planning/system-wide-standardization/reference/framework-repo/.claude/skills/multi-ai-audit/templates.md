...
| Placeholder               | Source                                                    |
| ------------------------- | --------------------------------------------------------- |
| `[GITHUB_REPO_URL]`       | Current git remote URL (run: `git remote get-url origin`) |
| `[Framework]`/`[Version]` | CLAUDE.md Section 1 (Stack Versions)                      |
| `[SCOPE]` directories     | Template's own Scope section or CLAUDE.md                 |
| `[Project Name]`          | CLAUDE.md project name or package.json name field         |
...
| code-quality (src/)        | CORE             |
| code-quality (default)     | CORE             |
| enhancements               | ENH              |
