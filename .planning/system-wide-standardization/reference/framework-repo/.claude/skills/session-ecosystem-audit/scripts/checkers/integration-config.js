...
/**
 * Core session-related hooks that should be registered and present.
 * This covers the minimal set expected in most session-management setups.
 * Projects may have additional hooks beyond these.
 *
 * Map of filename -> description for reporting.
 */
const SESSION_HOOKS = {
  'session-start.js': 'SessionStart bootstrap and validation',
