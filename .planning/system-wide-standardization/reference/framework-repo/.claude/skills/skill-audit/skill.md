...
- Quick structural validation — review the skill file manually
...
Phase 5: Validation     → Confirm structural and behavioral quality
```
...
2. Review current quality standards for skills
...
1. Update SKILL.md (keep under 300 lines per skill standards)
...
2. Verify behavioral quality against skill standards checklist
...
- **Neighbors:** `/skill-creator` (create/update)
