...
- No context document produced before planning
...
- Middle-ground tasks fall through the cracks
...
- Convention awareness — references project docs instead of duplicating?
...
- Conventions duplicated instead of referencing project docs
...
6. **Audits built into every plan** — at completion minimum, at phase boundaries
   for multi-phase
7. **Project conventions referenced** — via project docs, not duplicated
