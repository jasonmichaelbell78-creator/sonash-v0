---
name: doc-optimizer
description: Scan all docs, auto-fix formatting/headers/links, report issues as JSONL, and
...
### STEP 9: Cleanup & Artifact Removal

1. Stage & commit auto-fixed files (ask user first)
2. Delete temp files: `rm -rf .claude/state/doc-optimizer/`
3. Survey and offer to remove obsolete audit artifacts from docs/
