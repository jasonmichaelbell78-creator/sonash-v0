...
// === 1. ALERTS REMINDER ===
// eslint-disable-next-line complexity -- runAlerts has inherent branching (complexity 36), refactoring would reduce readability
function runAlerts() {
...
// eslint-disable-next-line complexity -- runAnalyze has inherent branching (complexity 44), refactoring would reduce readability
function runAnalyze() {
  ...
  function matchesWord(pattern) {
    ...
    // eslint-disable-next-line framework/no-unescaped-regexp-input -- input is pre-escaped above
