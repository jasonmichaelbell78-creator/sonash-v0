 ...
 *   1. large-context-warning — Context tracking + large file warnings
 *   2. auto-save-context    — Auto-save context to MCP memory when thresholds hit
 *
 * Phase 3 (compaction-handoff) is handled by pre-compaction-save.js, which
 * fires on PreCompact with richer data.
 *
 * Shared work:
...
function runContextTracking() {
  ...
  // Track this file read (only save when modified)
