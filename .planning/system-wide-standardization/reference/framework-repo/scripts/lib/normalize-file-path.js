...
/**
 * Normalize a file path for consistent hashing and display.
 *
 * Handles:
 ...
 * - Repo root stripping (e.g. "/home/user/project/lib/foo.ts" → "lib/foo.ts")
 *
...
function normalizeFilePath(filePath, options = {}) {
  ...
  if (stripRepoRoot) {
    ...
    if (repoName) {
      ...
      // eslint-disable-next-line framework/no-unbounded-regex -- input length is bounded by prior truncation
