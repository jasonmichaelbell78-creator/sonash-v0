...
1. **6 assessment domains identified:** security, actions, deps, config, release,
   insights
2. **Architecture:** resolution-first (not dashboard-first), interactive per-item
   triage, Fix/Defer/Skip
